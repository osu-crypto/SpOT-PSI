...
namespace osuCrypto
{
	u64 mRealStashSize=0;

	CuckooParam k2n32s40CuckooParam{ 4, 1, 2, u64(1) << 32 };
	CuckooParam k2n30s40CuckooParam{ 4, 1, 2, u64(1) << 30 };
	CuckooParam k2n28s40CuckooParam{ 2, 1, 2, u64(1) << 28 };
	CuckooParam k2n24s40CuckooParam{ 2, 1, 2, u64(1) << 24 };
	CuckooParam k2n20s40CuckooParam{ 2, 1, 2, u64(1) << 20 };
	CuckooParam k2n16s40CuckooParam{ 3, 1, 2, u64(1) << 16 };
	CuckooParam k2n12s40CuckooParam{ 5, 1, 2, u64(1) << 12 };
	CuckooParam k2n08s40CuckooParam{ 8, 1, 2, u64(1) << 8 };

	// not sure if this needs a stash of 40, but should be safe enough.
	CuckooParam k2n07s40CuckooParam{ 40, 1, 2, 1 << 7 };
	CuckooParam k2n06s40CuckooParam{ 40, 1, 2, 1 << 6 };
	CuckooParam k2n05s40CuckooParam{ 40, 1, 2, 1 << 5 };
	CuckooParam k2n04s40CuckooParam{ 40, 1, 2, 1 << 4 };
	CuckooParam k2n03s40CuckooParam{ 40, 1, 2, 1 << 3 };
	CuckooParam k2n02s40CuckooParam{ 40, 1, 2, 1 << 2 };
	CuckooParam k2n01s40CuckooParam{ 40, 1, 2, 1 << 1 };
    ...
    void CuckooHasher::print() const
    {
		...
		std::cout << "mBinScaler  " << k2n08s40CuckooParam.mBinScaler << std::endl;
		std::cout << "mStash.size()  " << mStash.size() << std::endl;
		std::cout << "mRealStashSize  " << mRealStashSize << std::endl;
